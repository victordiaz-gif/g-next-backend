...
export class AddCustomFields1758221067979 implements MigrationInterface {
   ...
   public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "order_line" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "quantity" integer NOT NULL, "orderPlacedQuantity" integer NOT NULL DEFAULT '0', "listPriceIncludesTax" boolean NOT NULL, "adjustments" text NOT NULL, "taxLines" text NOT NULL, "id" SERIAL NOT NULL, "sellerChannelId" integer, "shippingLineId" integer, "productVariantId" integer NOT NULL, "taxCategoryId" integer, "initialListPrice" integer, "listPrice" integer NOT NULL, "featuredAssetId" integer, "orderId" integer, "customFieldsSelectedsellerchannelid" character varying(255), "customFieldsSellerchannelcode" character varying(255), CONSTRAINT "PK_01a7c973d9f30479647e44f9892" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "seller" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "name" character varying NOT NULL, "id" SERIAL NOT NULL, "customFieldsConnectedaccountid" character varying(255), CONSTRAINT "PK_36445a9c6e794945a4a4a8d3c9d" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "seller_order" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "parentOrderId" character varying NOT NULL, "sellerId" character varying, "sellerName" character varying, "state" character varying NOT NULL, "currencyCode" character varying NOT NULL, "subtotalWithTax" integer NOT NULL, "shippingWithTax" integer NOT NULL, "taxTotal" integer NOT NULL, "totalWithTax" integer NOT NULL, "lineRefs" jsonb NOT NULL, CONSTRAINT "PK_30921475916652081efb9d7603d" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "ledger_entry" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "sellerId" character varying, "sellerName" character varying, "sellerOrderId" character varying, "type" character varying NOT NULL, "amountWithTax" integer NOT NULL, "reference" character varying, "description" character varying, CONSTRAINT "PK_04e9d274911f909a5848a15cd74" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "vendor_payout" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "sellerId" character varying NOT NULL, "sellerName" character varying, "amount" integer NOT NULL, "status" character varying NOT NULL, "externalId" character varying, "notes" character varying, CONSTRAINT "PK_bf32b44e1ba6defea6b43775047" PRIMARY KEY ("id"))`, undefined);
   ...
   public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`DROP TABLE "vendor_payout"`, undefined);
        await queryRunner.query(`DROP TABLE "ledger_entry"`, undefined);
        await queryRunner.query(`DROP TABLE "seller_order"`, undefined);
