...
async function importData() {
    console.log('🚀 Starting 100K products streaming import...');
    ...
    try {
        ...
        await processCSVStreaming(csvPath, importer, ctx);
        
        console.log('🔄 Rebuilding search index...');
        await searchService.reindex(ctx);
        
        console.log('✅ 100K products streaming import completed successfully!');
...
async function processCSVStreaming(csvPath: string, importer: Importer, ctx: RequestContext) {
